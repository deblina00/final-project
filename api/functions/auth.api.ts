...
import { dashboardProps, loginProps, OTpProps, registerProps, updatePassProps } from "@/typescript/auth.interface";
...
export const fetchDashboard: MutationFunction<dashboardProps, unknown> = async () => {
